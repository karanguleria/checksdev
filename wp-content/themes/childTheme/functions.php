...
function iconic_display_engraving_text_cart( $item_data, $cart_item ) {
    if ( empty( $cart_item['template-preview'] ) && empty( $cart_item['template-bg-preview'] )) {
        return $item_data;
    }
 
    $item_data[] = array(
        'key'     => __( 'Check Preview', 'iconic' ),
...
/*function iconic_add_engraving_text_to_order_items( $item, $cart_item_key, $values, $order ) {
    ...
    $item->add_meta_data( __( 'Check Preview', 'iconic' ), "<img src>".$values['template-preview']."" );
}
